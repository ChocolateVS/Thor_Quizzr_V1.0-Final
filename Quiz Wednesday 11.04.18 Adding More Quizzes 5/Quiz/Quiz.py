...
#Get Settings
with open('resources/files/fps.txt', 'r') as f: #Opens Frames Per Second File
...
#Gamedisplay setting
gameDisplay = pygame.display.set_mode((display_width,display_height), pygame.DOUBLEBUF, 32) #Initializes the Display
...
controls = pygame.image.load("resources/images/controls.png") #pygame.image.load loads an image from a file into the game
...
africa = pygame.image.load("resources/answers/jupiter/africa.jpg")
america = pygame.image.load("resources/answers/jupiter/america.png")
asia = pygame.image.load("resources/answers/jupiter/asia.png")
argon = pygame.image.load("resources/answers/jupiter/argon.jpg")
silver = pygame.image.load("resources/answers/jupiter/silver.png")
gold = pygame.image.load("resources/answers/jupiter/gold.png")
noway = pygame.image.load("resources/answers/jupiter/noway.png")
#noto = pygame.image.load("resources/answers/jupiter/not.jpg")
nope = pygame.image.load("resources/answers/jupiter/nope.jpg")
albert = pygame.image.load("resources/answers/jupiter/albert.jpg")
thomas = pygame.image.load("resources/answers/jupiter/thomas.jpg")
ben = pygame.image.load("resources/answers/jupiter/ben.jpg") 
dodec1 = pygame.image.load("resources/answers/jupiter/shape1.png")
dodec2 = pygame.image.load("resources/answers/jupiter/dodec.jpg")
dodec3 = pygame.image.load("resources/answers/jupiter/dodec.png")
george = pygame.image.load("resources/answers/jupiter/george.jpg")
jfk = pygame.image.load("resources/answers/jupiter/jfk.jpg")
hillary = pygame.image.load("resources/answers/jupiter/hillary.jpg")
hdmi = pygame.image.load("resources/answers/jupiter/hdmi.png")
sata = pygame.image.load("resources/answers/jupiter/sata.png")
ide = pygame.image.load("resources/answers/jupiter/ide.png")
cricket = pygame.image.load("resources/answers/jupiter/cricket.png")
basketball = pygame.image.load("resources/answers/jupiter/basketball.png")
soccer = pygame.image.load("resources/answers/jupiter/soccer.png")
canada = pygame.image.load("resources/answers/jupiter/turkeyflag.png")
peru = pygame.image.load("resources/answers/jupiter/peruflag.png")
turkey = pygame.image.load("resources/answers/jupiter/turkeyflag.png")
...
def jupiter_quiz():
    ...
    while not gameExit: #While Game Exit is not = true run everything below
        ...
        if jupiter_question1_run == False: #QUESTION 1
            gameDisplay.blit(bg, (0,0))
            gameDisplay.blit(jupiter_question_1, (125,0))
            gameDisplay.blit(albert, (50,320))
            questions_buttons(50,320,438,278, None, action = 'albert')
            gameDisplay.blit(ben, (200,150))
            questions_buttons(200,150,400,151, None, action = 'ben')
            gameDisplay.blit(thomas, (550,320))
            questions_buttons(550,320,200,278, None, action = 'thomas')
            pygame.display.update()
        elif jupiter_question1_run == True and jupiter_question2_run == False: #QUESTION 2
            gameDisplay.blit(bg, (0,0))
            gameDisplay.blit(jupiter_question_2, (0,0))
            gameDisplay.blit(argon, (50,200))
            questions_buttons(200,200,438,278, None, action = 'argon')
            gameDisplay.blit(gold, (200,200))
            questions_buttons(400,200,400,151, None, action = 'gold')
            gameDisplay.blit(silver, (550,200))
            questions_buttons(550,200,200,278, None, action = 'silver')
            pygame.display.update()
        elif jupiter_question1_run == True and jupiter_question2_run == True and jupiter_question3_run == False: #QUESTION 3
            gameDisplay.blit(bg, (0,0))
            gameDisplay.blit(jupiter_question_3, (100,0))
            gameDisplay.blit(num1, (50,230))
            questions_buttons(50,230,100,20, None, action = 'gamma1')
            gameDisplay.blit(num2, (200,230))
            questions_buttons(200,230,100,200, None, action = 'gamma2')
            gameDisplay.blit(num3, (350,230))
            questions_buttons(350,230,100,200, None, action = 'gamma3')
            gameDisplay.blit(num4, (500,230))
            questions_buttons(500,230,100,200, None, action = 'gamma4')
            gameDisplay.blit(num5, (650,230))
            questions_buttons(650,230,100,200, None, action = 'gamma5')
            pygame.display.update()
            ...
            gameDisplay.blit(bg, (0,0))
            gameDisplay.blit(jupiter_question_4, (0,0))
            pygame.display.update()
            ...
            gameDisplay.blit(bg, (0,0))
            gameDisplay.blit(jupiter_question_5, (0,0))
            pygame.display.update()
            ...
            gameDisplay.blit(bg, (0,0))
            gameDisplay.blit(jupiter_question_6, (0,0))
            pygame.display.update()
            ...
            gameDisplay.blit(bg, (0,0))
            gameDisplay.blit(jupiter_question_7, (0,0))
            pygame.display.update()
            ...
            gameDisplay.blit(bg, (0,0))
            gameDisplay.blit(jupiter_question_8, (0,0))
            pygame.display.update()
            ...
            gameDisplay.blit(bg, (0,0))
            gameDisplay.blit(jupiter_question_9, (0,0))
            pygame.display.update()
            ...
            gameDisplay.blit(bg, (0,0))
            gameDisplay.blit(jupiter_question_10, (0,0))
            pygame.display.update()

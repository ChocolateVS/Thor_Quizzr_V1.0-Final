...
def age():
    ...
    while not gameExit:
        ...
        age_button(display_width/2 - 60, display_height/2 + 140, 120, 60, grey, action = 'ok')
        if player_age > 100:
            player_age = 100
...
def help_menu():
    ...
    while not gameExit: #While Game Exit is not = true run everything below
        ...
        gameDisplay.blit(bg, (0,0))
        #gameDisplay.blit(helpbanner, (0,0))
        #gameDisplay.blit(help_message, (257,209))
